...
<div class="d-flex" id="wrapper">
    <div class="bg-dark col-1" id="sidebar-wrapper" style="padding-left: 0!important;">
        ...
        <div class="list-group list-group-flush"><a class="list-group-item list-group-item-action bg-dark text-white" style="padding-left: 50px">Продукты</a></div>
    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-6 d-flex align-items-start justify-content-end">
                        <button type="button" class="btn btn-primary btn-lg mt-4" data-toggle="modal" data-target="#addProductModal">
                            Добавить
                        </button>
                    </div>
                </div>
                ...
                <div class="modal fade" id="productModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Артикул <span id="modalArticle"></span></p>
                                <p>Название <span id="modalName"></span></p>
                                <p>Статус <span id="modalStatus"></span></p>
                                <p>Атрибуты <span id="modalAttributes"></span></p>
                            </div>
